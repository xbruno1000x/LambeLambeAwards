    ...
    <div class="col-lg-6">
        <div class="card">
            <div class="card-header">
                <h5 class="mb-0"><i class="bi bi-plus-circle me-2"></i>Criar Nova Edição</h5>
            </div>
            <div class="card-body">
                <form action="{{ route('admin.edicoes.store') }}" method="POST">
                    @csrf
                    ...
                    <div class="d-flex gap-2">
                        <button type="submit" class="btn btn-primary">
                            <i class="bi bi-check-circle me-1"></i>Criar Edição
                        </button>
