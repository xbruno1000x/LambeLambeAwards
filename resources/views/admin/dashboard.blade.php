        ...
        <div class="card-body">
            <div class="row align-items-center">
                <div class="col-12 col-md-6 mb-3 mb-md-0">
                    <h3 class="text-gold fs-4 fs-md-3">
                        {{ $edicaoAtiva->ano }}
                ...
                <div class="col-12 col-md-6 text-md-end">
                    <div class="d-flex flex-column flex-sm-row gap-2 justify-content-md-end">
                        <form action="{{ route('admin.edicoes.toggle-votacao', $edicaoAtiva) }}" method="POST" class="d-inline">
                            @csrf
                            <button type="submit" class="btn {{ $edicaoAtiva->votacao_aberta ? 'btn-danger' : 'btn-success' }} w-100 w-sm-auto">
                                <i class="bi {{ $edicaoAtiva->votacao_aberta ? 'bi-lock' : 'bi-unlock' }} me-1"></i>
                                {{ $edicaoAtiva->votacao_aberta ? 'Fechar Votação' : 'Abrir Votação' }}
                            </button>
                        </form>
                        <a href="{{ route('admin.edicoes.show', $edicaoAtiva) }}" class="btn btn-outline-primary w-100 w-sm-auto">
    ...
    <div class="col-12 col-md-4">
        <div class="card h-100">
            <div class="card-body text-center p-3 p-md-4">
                ...
                <p class="text-muted small d-none d-md-block">Crie e gerencie as edições do prêmio</p>
    ...
    <div class="col-12 col-md-4">
        <div class="card h-100">
            <div class="card-body text-center p-3 p-md-4">
                ...
                <p class="text-muted small d-none d-md-block">Crie categorias para cada edição</p>
    ...
    <div class="col-12 col-md-4">
        <div class="card h-100">
            <div class="card-body text-center p-3 p-md-4">
                ...
                <p class="text-muted small d-none d-md-block">Adicione indicados às categorias</p>
